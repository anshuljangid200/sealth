               ...
               <div className="divide-y divide-slate-50 dark:divide-slate-800">
                  {clients.map((client, i) => (
                     <div key={i} className="p-6 flex items-center gap-6 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all group cursor-pointer">
                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary/40 to-primary/20 dark:from-primary/30 dark:to-primary/10 flex items-center justify-center text-slate-900 dark:text-white font-black italic shadow-sm border-2 border-slate-200 dark:border-slate-700 group-hover:border-primary/50 transition-all text-xl">
                           {client.avatar}
                        </div>
