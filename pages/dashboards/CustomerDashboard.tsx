        ...
        <Card className="lg:col-span-1 p-8 bg-slate-950 dark:bg-slate-900/50 border-none relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex justify-between items-center mb-8">
              ...
              <button onClick={() => navigate('consults')} aria-label="View all consultations" title="View all consultations" className="p-2 text-white/40 hover:text-white transition-colors">
            ...
            <div className="flex items-center gap-4 mb-8">
              <img
                ...
                alt=""
                className="w-16 h-16 rounded-2xl object-cover ring-4 ring-white/20 border-2 border-white/30"
              />
              <div>
