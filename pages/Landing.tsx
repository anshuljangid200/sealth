        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative">
              ...
              <div className="h-10 w-10 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-xl flex items-center justify-center border border-slate-200/50 dark:border-slate-700/50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-lg leading-relaxed font-medium">
                Personalized nutrition, real-time health tracking, and expert consultations. All designed for your longevity.
              </p>
